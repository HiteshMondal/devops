...
# Free Tier compatible: t3.micro / t2.micro instances, 12-month free tier
###############################################################################
...
# NOTE: These reference aws_eks_cluster.main directly (defined in eks.tf)
#       Terraform resolves cross-file resource references automatically.
provider "kubernetes" {
