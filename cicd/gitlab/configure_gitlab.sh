...
configure_gitlab () {
  ...
  echo -e "  --description 'devops-docker-runner' \\"
  echo -e "  --tag-list 'devops,ci,minikube' \\"
  echo -e "  --run-untagged='true' \\"
  echo -e "  --docker-privileged=true \\"
  echo -e "  --docker-volumes /var/run/docker.sock:/var/run/docker.sock \\"
  echo -e "  -docker-volumes /home/gitlab-runner/.kube:/root/.kube \\"
  echo -e "  --docker-network-mode host\\"
  echo -e "  --locked='false'${RESET}"
  echo ""
